...
**IPC contract** (`src/shared/ipc-contract.ts`) is the single source of truth — 109 methods. The preload bridge and `ElectronAPI` type are auto-derived from it.
